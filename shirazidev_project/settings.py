"""
Django's settings for shirazidev_project project.
...
ROOT_URLCONF = 'shirazidev_project.urls'
...
WSGI_APPLICATION = 'shirazidev_project.wsgi.application'
...
PWA_APP_NAME = 'ShiraziDEV'
PWA_APP_DESCRIPTION = "SHIRAZIDEV PERSONAL SITE"
...
PWA_APP_ICONS = [
    {
        'src': '/static/img/whitenamelogo.png',
        'sizes': '160x160'
    }
]
PWA_APP_ICONS_APPLE = [
